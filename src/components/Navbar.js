...
const Navbar = () => (
  <header className="nav-header">
    <a className="mobile-logo" href="/"><img src="https://fontmeme.com/permalink/211213/76249c96f4e1610fcb6b67283cb75705.png" alt="logo" border="0" /></a>

    <nav className="desktop-menu">
      <div className="left">
        <a className="logo" href="/"><img src="https://fontmeme.com/permalink/211213/76249c96f4e1610fcb6b67283cb75705.png" alt="logo" border="0" /></a>
